...
//           <li>
//             <span className="font-semibold text-gray-700">Exercise</span>: Regular physical activity can help reduce symptoms.
//           </li>
//           <li>
//             <span className="font-semibold text-gray-700">Diet</span>: Eating a balanced diet can improve mood and energy levels.
//           </li>
//           <li>
//             <span className="font-semibold text-gray-700">Sleep</span>: Ensuring adequate rest is crucial for mental health.
//           </li>
//         </ul>
//       ),
//     },
...
//       content: (
//         <p>
//           Consulting with therapists, counselors, or psychiatrists who can provide diagnosis and treatment plans.
//         </p>
//       ),
//     },
//     {
...
//       content: (
//         <p>
//           Inpatient treatment, medication management, or other advanced therapies tailored to individual needs.
//         </p>
//       ),
//     },
//     {
...
//       content: (
//         <p>
//           Support groups offer community and shared experiences helpful for recovery and coping.
//         </p>
//       ),
//     },
//     {
...
//   return (
//     <main className="bg-white p-6 max-w-md mx-auto">

//       <div className=" sm:hidden block mt-6 border border-gray-300 text-sm text-left">
...
//                 className="w-full p-3 text-left font-semibold text-indigo-800 hover:underline focus:outline-none"
...
//             </div>
//             {openSection === key && (
//               <div className="border-b border-gray-300 p-3 text-gray-600">
//                 {content}
//               </div>
//             )}
//           </div>
